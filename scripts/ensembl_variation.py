...
urls = [
    "ftp://ftp.ensembl.org/pub/{reference}/release-{release}/variation/vcf/{species}/{species}{suffix}.vcf.gz".format(
        reference=reference, release=release, species=species, suffix=suffix
    )
